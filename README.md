...
| **watch-git** | `rules/watch-git.yml` | Force push, branch -D, and other destructive git ops (block); add, commit, push, reset --hard, force-with-lease, and other mutating ops (ask) |
