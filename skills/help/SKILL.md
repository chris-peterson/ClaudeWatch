...
| `watch-git` | No-recovery (force push) and recoverable mutating (commit, push, push --delete, reset --hard, branch -D, force-with-lease) git ops — stage-only ops (add, rm, non-hard reset) allowed |
